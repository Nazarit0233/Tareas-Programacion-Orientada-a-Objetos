...
public class Buga {
	...
	public Buga(int firmasRecolectadas, String privilegio) {
	...
	public String toString() {
		return "Buga: " + firmasRecolectadas + " firmas, Privilegio: " + privilegio + ", Anuladas: " + firmasAnuladas + ", Fecha: " + fechaRegistro;
	}
}
